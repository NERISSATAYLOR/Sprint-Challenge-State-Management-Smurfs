...
doesnt have to pass props use the context Provider to help you retrieve the necessary data in store data on context object not  props

- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

actions decribe the update and tell the reducer what to do.
reducer: return the updated state
store : hold all the global state in one place

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

since reducer flow is synchronous redux-thunk is a function returns a function   flow asynchronous so we can make API calls from our action creators.

- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
I like context better than redux because I think it controls state better in  small projects but I can see when you can use Redux when you have complex components.
